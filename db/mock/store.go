...
// Source: readoGift/db/sqlc (interfaces: Store)
...
func (m *MockStore) DeleteAccount(arg0 context.Context, arg1 int64) (db.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteEntry(arg0 context.Context, arg1 int64) (db.Entries, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteTransfer(arg0 context.Context, arg1 int64) (db.Transfers, error) {
	m.ctrl.T.Helper()
